...
func _ready():
	...
	# Warning if no shoot point
	if not shoot_point:
		print("WARNING: No ShootPoint found! Add a Marker3D named 'ShootPoint' to the weapon.")
...
func _process(delta):
	...
	# Primary fire - HOLD for automatic fire
...
func shoot():
	...
	# Get shoot origin and direction - USE SHOOT POINT!
	...
	# Spawn bullet tracer FROM THE BARREL
...
func shoot_explosive():
	...
	# Spawn explosion tracer FROM THE BARREL
...
func spawn_impact_effect(pos: Vector3):
	# Main impact sparks - BIGGER and CHUNKIER
	var particles = GPUParticles3D.new()
	particles.emitting = true
	particles.one_shot = true
	particles.amount = 25  # More particles!
	particles.lifetime = 0.5  # Last longer
	...
	material.spread = 60  # Wider spread
	material.initial_velocity_min = 5.0  # Faster!
	material.initial_velocity_max = 12.0
	material.gravity = Vector3(0, -15, 0)  # Stronger gravity
	material.scale_min = 0.08  # Bigger particles
	...
	mesh.size = Vector2(0.1, 0.1)  # Bigger quads
	particles.draw_pass_1 = mesh
	
	get_tree().root.add_child(particles)
	particles.global_position = pos
	
	# Add impact flash sphere
...
func spawn_explosion_effect(pos: Vector3):
	...
	particles.emitting = true
	particles.one_shot = true
	particles.amount = 100  # Way more particles!
	particles.lifetime = 1.5
	particles.explosiveness = 1.0
	
	var material = ParticleProcessMaterial.new()
	material.emission_shape = ParticleProcessMaterial.EMISSION_SHAPE_SPHERE
	material.emission_sphere_radius = 1.0  # Bigger emission
	material.direction = Vector3(0, 1, 0)
	material.spread = 180
	material.initial_velocity_min = 8.0  # Faster!
	material.initial_velocity_max = 18.0
	material.gravity = Vector3(0, -20, 0)  # Stronger gravity
	...
	# Add screen distortion (chromatic aberration would go here)
...
func spawn_smoke_puff(pos: Vector3):
	...
	material.gravity = Vector3(0, 2, 0)  # Smoke rises
	material.damping_min = 1.0
	material.damping_max = 2.0
	
	# Scale up over time (smoke expands)
